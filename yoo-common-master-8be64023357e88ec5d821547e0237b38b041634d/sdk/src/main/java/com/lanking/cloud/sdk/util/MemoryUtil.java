...
public class MemoryUtil {
	...
	/**
	 * The size in bytes of a native pointer: 4 for 32 bit, 8 for 64 bit
	 */
	private static final long ADDRESS_SIZE;
	/**
	 * The size of a Java reference: 4 for 32 bit, 4 for 64 bit compressed oops,
	 * 8 for 64 bit
	 */
	private static final long REFERENCE_SIZE;
	/**
	 * The minimum size of an Object: 8 for 32 bit, 12 for 64 bit compressed
	 * oops, 16 for 64 bit
	 */
	...
	public static long shallowSizeOf(final Object object) {
		...
		if (objectClass.isArray()) {
			long size = UNSAFE.arrayBaseOffset(objectClass) + UNSAFE.arrayIndexScale(objectClass)

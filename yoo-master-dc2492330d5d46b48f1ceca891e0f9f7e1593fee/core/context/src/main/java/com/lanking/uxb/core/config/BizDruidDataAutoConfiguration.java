...
@Configuration
public class BizDruidDataAutoConfiguration {
	...
	@ConfigurationProperties("spring.datasource.druid.m")
	public DataSource masterBizDataSource() {
		return DruidDataSourceBuilder.create().build();
	}

	@Bean(value = "masterSlaveBizDataSource", destroyMethod = "close")
	@Qualifier("masterSlaveBizDataSource")
	@ConfigurationProperties("spring.datasource.druid.ms")
	public DataSource masterSlaveBizDataSource() {
		return DruidDataSourceBuilder.create().build();
	}

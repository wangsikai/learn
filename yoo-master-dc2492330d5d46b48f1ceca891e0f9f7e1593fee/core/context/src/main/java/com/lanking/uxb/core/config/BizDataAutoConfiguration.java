...
import com.lanking.cloud.component.db.masterslave.DynamicDataSource;
...
public class BizDataAutoConfiguration {
	...
	@Bean("masterBizDataSourceProperties")
	@Qualifier("masterBizDataSourceProperties")
	@ConfigurationProperties("yoo-cloud.datasource.biz.m")
	DataSourceProperties masterBizDataSourceProperties() {
		return new DataSourceProperties();
	}

	@Bean("masterSlaveBizDataSourceProperties")
	@Qualifier("masterSlaveBizDataSourceProperties")
	@ConfigurationProperties("yoo-cloud.datasource.biz.ms")
	DataSourceProperties masterSlaveBizDataSourceProperties() {
		return new DataSourceProperties();
	}

	@Bean(value = "masterBizDataSource", destroyMethod = "close")
	@Qualifier("masterBizDataSource")
	@ConfigurationProperties("yoo-cloud.datasource.biz.m")
	DataSource masterBizDatasource(
			@Qualifier("masterBizDataSourceProperties") DataSourceProperties bizDataSourceProperties) {
		DataSource dataSource = bizDataSourceProperties.initializeDataSourceBuilder().build();
		return dataSource;
	}

	@Bean(value = "masterSlaveBizDataSource", destroyMethod = "close")
	@Qualifier("masterSlaveBizDataSource")
	@ConfigurationProperties("yoo-cloud.datasource.biz.ms")
	DataSource masterSlaveBizDataSource(
			@Qualifier("masterSlaveBizDataSourceProperties") DataSourceProperties bizDataSourceProperties) {
		DataSource dataSource = bizDataSourceProperties.initializeDataSourceBuilder().build();
		return dataSource;
	}
	...
	DataSource bizDataSource(@Qualifier("masterBizDataSource") DataSource masterBizDataSource,
			@Qualifier("masterSlaveBizDataSource") DataSource masterSlaveBizDataSource) {
		DynamicDataSource dynamicDataSource = new DynamicDataSource();
		dynamicDataSource.setDefaultTargetDataSource(masterBizDataSource);
		Map<Object, Object> targetDataSources = Maps.newHashMap();
		targetDataSources.put("M", masterBizDataSource);
		targetDataSources.put("MS", masterSlaveBizDataSource);

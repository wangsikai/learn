...
@Component
public class DoQuestionSchoolRankConvert extends Converter<VDoQuestionRank, DoQuestionSchoolRank, Long> {

	@Autowired
	private UserConvert userConvert;

	@Override
	protected Long getId(DoQuestionSchoolRank s) {
		return s.getId();
	}

	@Override
	protected VDoQuestionRank convert(DoQuestionSchoolRank s) {
	...
	protected void initAssemblers(List<ConverterAssembler> assemblers) {
		// 学生信息
		assemblers.add(new ConverterAssembler<VDoQuestionRank, DoQuestionSchoolRank, Long, VUser>() {

			@Override
			public boolean accept(DoQuestionSchoolRank s) {
				return true;
			}
			...
			@Override
			public Long getKey(DoQuestionSchoolRank s, VDoQuestionRank d) {
				return s.getUserId();
			}

			@Override
			public void setValue(DoQuestionSchoolRank s, VDoQuestionRank d, VUser value) {
				d.setUser(value);
			}

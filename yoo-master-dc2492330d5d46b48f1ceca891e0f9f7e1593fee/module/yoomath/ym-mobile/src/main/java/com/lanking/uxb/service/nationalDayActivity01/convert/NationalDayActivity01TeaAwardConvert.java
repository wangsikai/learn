...
@Component
public class NationalDayActivity01TeaAwardConvert
		extends Converter<VNationalDayActivity01Award, NationalDayActivity01TeaAward, Long> {

	@Autowired
	private UserConvert userConvert;

	@Override
	protected Long getId(NationalDayActivity01TeaAward s) {
		return s.getUserId();
	}

	@Override
	protected VNationalDayActivity01Award convert(NationalDayActivity01TeaAward s) {
	...
	protected void initAssemblers(List<ConverterAssembler> assemblers) {
		// 用户信息
		assemblers
				.add(new ConverterAssembler<VNationalDayActivity01Award, NationalDayActivity01TeaAward, Long, VUser>() {

					@Override
					public boolean accept(NationalDayActivity01TeaAward s) {
						return true;
					}
					...
					@Override
					public Long getKey(NationalDayActivity01TeaAward s, VNationalDayActivity01Award d) {
						return s.getUserId();
					}

					@Override
					public void setValue(NationalDayActivity01TeaAward s, VNationalDayActivity01Award d, VUser value) {
						d.setUser(value);
					}

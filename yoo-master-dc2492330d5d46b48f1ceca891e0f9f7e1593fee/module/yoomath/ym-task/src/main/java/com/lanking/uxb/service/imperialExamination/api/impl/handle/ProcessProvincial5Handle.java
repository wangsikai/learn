 ...
 */
@Component
public class ProcessProvincial5Handle extends AbstractImperialExaminationProcessHandle {
	...
	public ImperialExaminationProcess getProcess() {
		return ImperialExaminationProcess.PROCESS_PROVINCIAL5;
	}
	...
	public synchronized void process(long code) {
		...
		try {
			...
			logger.error("PROCESS_PROVINCIAL5 fail:"+e);

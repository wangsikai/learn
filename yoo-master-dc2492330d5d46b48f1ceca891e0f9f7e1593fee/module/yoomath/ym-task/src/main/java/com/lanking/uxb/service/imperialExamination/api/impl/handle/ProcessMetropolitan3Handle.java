 ...
 * */
@Component
public class ProcessMetropolitan3Handle extends AbstractImperialExaminationProcessHandle {
	...
	public ImperialExaminationProcess getProcess() {
		return ImperialExaminationProcess.PROCESS_METROPOLITAN3;
	}
	...
	public synchronized void process(long code) {
		...
		try {
			...
			logger.error("PROCESS_METROPOLITAN3 fail:"+e);

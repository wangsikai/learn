...
/**
 * SectionPractiseQuestion VO
 *
 * @author xinyu.zhou
 * @since yoomath(mobile) V1.1
 */
public class VSectionPractiseQuestion implements Serializable {
	private static final long serialVersionUID = 9190467915794516861L;

...
public class RefundQueryBusiness {
	...
	public RefundQueryBusiness(Configure configure) throws IllegalAccessException, ClassNotFoundException,
	...
	public void run(RefundQueryReqData refundQueryReqData, RefundQueryBusiness.ResultListener resultListener)
		...
		refundQueryServiceResponseString = refundQueryService.request(refundQueryReqData, configure);
		...
		RefundQueryResData refundQueryResData = (RefundQueryResData) Util.getObjectFromXML(
				refundQueryServiceResponseString, RefundQueryResData.class);

		ReportReqData reportReqData = new ReportReqData(configure, refundQueryReqData.getDevice_info(),
				APIConfigure.REFUND_QUERY_API,
				...
				refundQueryResData.getErr_code_des(), refundQueryResData.getOut_trade_no(), configure.getIP());

		long timeAfterReport;
		if (APIConfigure.isUseThreadToDoReport()) {

...
public class HttpsRequest {
	...
	public HttpsRequest(Configure configure) throws UnrecoverableKeyException, KeyManagementException,
			NoSuchAlgorithmException, KeyStoreException, IOException {
		init(configure);
	}

	private void init(Configure configure) throws IOException, KeyStoreException, UnrecoverableKeyException,
	...
	public String sendPost(String url, Object xmlObj, Configure configure) throws IOException, KeyStoreException,

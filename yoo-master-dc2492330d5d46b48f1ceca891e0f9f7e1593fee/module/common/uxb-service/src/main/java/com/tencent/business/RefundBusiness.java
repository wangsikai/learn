...
public class RefundBusiness {
	...
	public RefundBusiness(Configure configure) throws IllegalAccessException, ClassNotFoundException,
	...
	public void run(RefundReqData refundReqData, ResultListener resultListener) throws Exception {
		...
		refundServiceResponseString = refundService.request(refundReqData, configure);

...
public class DuplicateRemoverTmcHandler extends TmcHandler {
	...
	public DuplicateRemoverTmcHandler(TmcClient tmcClient) {
		...
		this.scheduledService = Executors.newSingleThreadScheduledExecutor(new NamedThreadFactory(
				"tmc-duplicate-remover"));
		this.scheduledFuture = this.scheduledService.scheduleWithFixedDelay(new MsgScheduleTask(), SCHEDULE_DELAY,

 ...
 */
public class AlibabaAliqinFcVoiceNumDoublecallRequest extends
		BaseTaobaoRequest<AlibabaAliqinFcVoiceNumDoublecallResponse> {
	...
	/**
	 * 被叫号码侧的号码显示，传入的显示号码可以是阿里大鱼“管理中心-号码管理”中申请通过的号码。显示号码格式如下057188773344，
	 * 4001112222，95500。显示号码也可以为主叫号码。
	 */
	...
	/**
	 * 主叫号码侧的号码显示，传入的显示号码必须是阿里大鱼“管理中心-号码管理”中申请通过的号码。显示号码格式如下057188773344，
	 * 4001112222，95500
	 */

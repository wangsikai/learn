...
public class Endpoint {
	...
	public synchronized EndpointProxy getEndpoint(Identity target, URI uri, Map<String, Object> extras)
	...
	protected Map<String, Object> sendAndWait(EndpointProxy e, ChannelSender sender, Message message, int timeout)
			throws LinkException {

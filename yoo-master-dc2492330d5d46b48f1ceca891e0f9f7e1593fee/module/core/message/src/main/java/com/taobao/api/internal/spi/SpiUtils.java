...
public class SpiUtils {
	...
	private static boolean checkSign(HttpServletRequest request, Map<String, String> form, String body, String secret,
		...
		if (localSign.equals(remoteSign)) {
			...
			log.error("checkTopSign error^_^remoteSign=" + remoteSign + "^_^localSign=" + localSign + "^_^paramStr="
					+ paramStr + "^_^body=" + body);
			return false;
		}
	}

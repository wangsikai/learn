...
public class SDKServiceBindingStub extends org.apache.axis.client.Stub implements cn.b2m.eucp.sdkhttp.SDKClient {
	...
	public cn.b2m.eucp.sdkhttp.StatusReport[] getReport(java.lang.String arg0, java.lang.String arg1)
		...
		try {
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				try {
					...
					return (cn.b2m.eucp.sdkhttp.StatusReport[]) org.apache.axis.utils.JavaUtils.convert(_resp,
							cn.b2m.eucp.sdkhttp.StatusReport[].class);
				}
			}
		} catch (org.apache.axis.AxisFault axisFaultException) {
			throw axisFaultException;
		...
		try {
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				try {
					...
					return (cn.b2m.eucp.sdkhttp.Mo[]) org.apache.axis.utils.JavaUtils.convert(_resp,
							cn.b2m.eucp.sdkhttp.Mo[].class);
				}
			}
		} catch (org.apache.axis.AxisFault axisFaultException) {
			throw axisFaultException;
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 1; i < 10; i++) {
			sb.append(i);
			String sendValue = client.sendVoice("2SDK-EMY-6688-JBUQR", "911305", null, new String[] { "13717882257" },
					sb.toString(), "", "GBK", 5, System.currentTimeMillis());

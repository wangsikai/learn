 ...
 */
@Component
@IndexType(type = com.lanking.cloud.domain.type.IndexType.USER_QUESTION_COLLECT)
public class CollectionQuestionDoc extends AbstraceIndexDoc {

	private static final long serialVersionUID = 9214465538403531172L;

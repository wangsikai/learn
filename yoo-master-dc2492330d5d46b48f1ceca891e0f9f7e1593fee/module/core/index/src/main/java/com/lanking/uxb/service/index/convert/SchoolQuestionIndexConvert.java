 ...
 */
@Component
public class SchoolQuestionIndexConvert extends Converter<SchoolQuestionDoc, SchoolQuestion, Long> {
	...
	@Override
	protected SchoolQuestionDoc convert(SchoolQuestion s) {
		SchoolQuestionDoc v = new SchoolQuestionDoc();
		v.setId(s.getId());
		v.setQuestionId(s.getQuestionId());
		v.setSchoolId(s.getSchoolId());
	...
	protected void initAssemblers(List<ConverterAssembler> assemblers) {
		...
		assemblers.add(new ConverterAssembler<SchoolQuestionDoc, SchoolQuestion, Long, Question>() {
			...
			@Override
			public Long getKey(SchoolQuestion s, SchoolQuestionDoc d) {
				return s.getQuestionId();
			}

			@Override
			public void setValue(SchoolQuestion s, SchoolQuestionDoc d, Question value) {
				if (value != null) {
					d.setSceneCode(value.getSceneCode());
		...
		// 知识点
		assemblers.add(new ConverterAssembler<SchoolQuestionDoc, SchoolQuestion, Long, List<MetaKnowpoint>>() {
			...
			@Override
			public void setValue(SchoolQuestion s, SchoolQuestionDoc d, List<MetaKnowpoint> value) {
		...
		// 知识点（新）
		assemblers.add(new ConverterAssembler<SchoolQuestionDoc, SchoolQuestion, Long, List<KnowledgePoint>>() {
			...
			@Override
			public void setValue(SchoolQuestion s, SchoolQuestionDoc d, List<KnowledgePoint> value) {
				if (CollectionUtils.isNotEmpty(value)) {
					StringBuffer buff = new StringBuffer();
		...
		// 教材章节
		assemblers.add(new ConverterAssembler<SchoolQuestionDoc, SchoolQuestion, Long, Map<String, List<Long>>>() {
			...
			@Override
			public void setValue(SchoolQuestion s, SchoolQuestionDoc d, Map<String, List<Long>> value) {
		...
		// 子题
		assemblers.add(new ConverterAssembler<SchoolQuestionDoc, SchoolQuestion, Long, String>() {
			@Override
			public boolean accept(SchoolQuestion s) {
				return true;
			}
			...
			@Override
			public void setValue(SchoolQuestion s, SchoolQuestionDoc d, String value) {

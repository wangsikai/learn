...
@Component
public class ResconStatisNewKnowpointConvert extends Converter<VStatisKnowpoint, VKnowledgeSystem, Long> {

	@Override
	protected Long getId(VKnowledgeSystem s) {
		return Long.valueOf(s.getCode());
	}

	@Override
	protected VStatisKnowpoint convert(VKnowledgeSystem s) {

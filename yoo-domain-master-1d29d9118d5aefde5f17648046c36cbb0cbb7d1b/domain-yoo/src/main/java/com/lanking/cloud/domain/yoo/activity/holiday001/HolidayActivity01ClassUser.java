 ...
 */
@Entity
@Table(name = "holiday_activity_01_class_user")
public class HolidayActivity01ClassUser implements Serializable {

	private static final long serialVersionUID = -797336660458810176L;

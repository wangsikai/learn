...
@Getter
@Entity
@Table(name = "imperial_exam_activity_award")
public class ImperialExaminationActivityAward implements Serializable {

	private static final long serialVersionUID = 5141154235855411163L;

...
@Getter
@Entity
@Table(name = "imperial_exam_homework_student")
public class ImperialExaminationHomeworkStudent implements Serializable {

	private static final long serialVersionUID = 8128101429954511658L;

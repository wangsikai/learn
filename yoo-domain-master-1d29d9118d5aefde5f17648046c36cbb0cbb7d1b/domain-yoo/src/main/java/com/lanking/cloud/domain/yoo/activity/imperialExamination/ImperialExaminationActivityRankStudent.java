...
@Getter
@Entity
@Table(name = "imperial_exam_activity_rank_student")
public class ImperialExaminationActivityRankStudent implements Serializable {

	private static final long serialVersionUID = -857301310053739849L;

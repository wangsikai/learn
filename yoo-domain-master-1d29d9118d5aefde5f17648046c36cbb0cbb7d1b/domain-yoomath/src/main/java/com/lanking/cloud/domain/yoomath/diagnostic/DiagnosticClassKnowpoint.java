 ...
 */
@Entity
@Table(name = "diagno_class_kp")
public class DiagnosticClassKnowpoint implements Serializable {

	private static final long serialVersionUID = -8805304651799190981L;

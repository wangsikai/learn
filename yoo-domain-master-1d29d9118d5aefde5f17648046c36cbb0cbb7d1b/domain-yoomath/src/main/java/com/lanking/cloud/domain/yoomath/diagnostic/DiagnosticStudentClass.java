 ...
 */
@Entity
@Table(name = "diagno_stu_class")
public class DiagnosticStudentClass implements Serializable {

	private static final long serialVersionUID = -5837815356103699482L;

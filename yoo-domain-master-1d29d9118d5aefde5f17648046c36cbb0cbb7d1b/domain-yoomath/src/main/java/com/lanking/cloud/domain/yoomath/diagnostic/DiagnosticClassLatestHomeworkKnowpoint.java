 ...
 */
@Entity
@Table(name = "diagno_class_latest_hk_kp")
public class DiagnosticClassLatestHomeworkKnowpoint implements Serializable {

	private static final long serialVersionUID = 1802181860177963541L;

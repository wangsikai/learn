 ...
 */
@Entity
@Table(name = "section_practise_question")
public class SectionPractiseQuestion implements Serializable {
	private static final long serialVersionUID = 517551378482253181L;

...
@MappedSuperclass
public class QuestionKnowledgeSyncKey implements Serializable {
	...
	public QuestionKnowledgeSyncKey(long questionId, int knowledgeCode) {
		this.questionId = questionId;
		this.knowledgeCode = knowledgeCode;
	}

	public QuestionKnowledgeSyncKey() {
	}

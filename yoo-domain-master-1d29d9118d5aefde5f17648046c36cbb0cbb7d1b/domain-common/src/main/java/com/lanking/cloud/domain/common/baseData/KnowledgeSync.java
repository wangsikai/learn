...
@Getter
@Entity
@Table(name = "knowledge_sync")
public class KnowledgeSync extends AbstractMongoObject implements Serializable {

	private static final long serialVersionUID = -130030754213670890L;
